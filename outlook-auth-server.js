...
const AUTH_CONFIG = {
  ...
  tenantId: process.env.MS_TENANT_ID || 'common', // Set your tenant ID, defaults to 'common' for multi-tenant
...
const server = http.createServer((req, res) => {
  ...
  if (pathname === '/auth/callback') {
    ...
    const authUrl = `https://login.microsoftonline.com/${AUTH_CONFIG.tenantId}/oauth2/v2.0/authorize?${querystring.stringify(authParams)}`;
